...
{
    public class NewProjectBudgetReportController : Controller
    {
        ...
        public NewProjectBudgetReportController(IConfiguration configuration, ICommonRepository commonRepository)
        {
        ...
        public async Task<IActionResult> ProjectBudgetPBReport(string ProjectId)
        {
            ...
            using (var client = new PowerBIClient(new Uri(data.ApiUrl), tokenCredentials))
            {
                ...
                var logresponse = SavePowerBILogsInfo(Convert.ToString(reportId), "Project Budget Report");
        ...
        public async Task<IActionResult> BudgetPBReport()
        {
...

            {
                ...
                var logresponse = SavePowerBILogsInfo(Convert.ToString(reportId), "Budget Report");
