...
function createJqGrid(data) {
    ...
    $("#ProjectResouceMasterGrid").trigger("reloadGrid");
}
...
$(document).on('click', '#ProjectResourceMasterExport', function () {
    ...
    //var projects = $('#Projects').val().toString();
    //var resources = $('#Resource').val().toString();
    //location.href = ROOT + 'EffortTracker/ExportProjectList?q=' + Encrypt("Projects=" + projects + "&Resources=" + resources );
});
