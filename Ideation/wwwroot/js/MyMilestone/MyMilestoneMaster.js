...
function pendingMilestoneList() {
    ...
    $.ajax({
        ...
        type: 'GET',
        dataType: 'JSON',
        url: ROOT + "Milestone/GetMyMileStoneList",
        data: {
            status: Status
        },
        ...
        colModel: [
            ...
            //},
            {
                ...
                formatter: function (cellvalue, options, rowobject) {
                    return '<div><a style="color:blue!important;cursor:pointer;" href="' + ROOT + 'Milestone/Index?q=' + Encrypt('ProjectId=' + rowobject.ProjectId + '&HubId=' + rowobject.Hub) + '">' + rowobject.ProjectCode + '</a></div>';
                }
            },
            {
                name: 'ProjectName',
