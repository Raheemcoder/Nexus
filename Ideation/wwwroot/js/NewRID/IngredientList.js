    ...
    jQuery("#prd_desc1").jqGrid({
        ...
        colModel: [
            ...
            },
            {
                ...
                search: false,
                formatter: function (cellvalue, options, rowobject) {
                    return '<div class="action_icons d-flex justify-content-around align-items-center">' +
                                '<a href="#" class="btn-icon" onclick="ShowHistory(' + rowobject.IngredientId + ', this)" data-ingName="' + rowobject.IngredientName + '" title="History">' +
