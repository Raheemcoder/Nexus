...
$(document).ready(function () {
                ...
                if (rowobject.StatusId == 3) {
                    ...
                    return `<div class="text-center">
                            ...
                            <div class="save_edit1">
                                <span class="view-color -view" onclick="onClickSaveInGridRowDuringReject(this)"><i class="fas fa-save" title="Save"></i></span>
                                <span class="btn-times -delete time_cross pl-1" onclick="onClickCloseInGridRowDuringReject(this)"><i class="fas fa-times-circle" title="Close"></i></span>
                            </div>
                        </div>`;
                }
                else {
            ...
            formatter: function (cellvalue, options, rowobject) {
                ...
                if (rowobject.StatusId != 3) {
                    ...
                    if (businessLaunchDateValue == "" || businessLaunchDateValue == null || businessLaunchDateValue == undefined) {
                        ...
                        <input type="text" onpaste="return false;" autocomplete = "off" class="form-control input_height data-datepicker BusinessLaunchDate datepicker-input" id='`+ rowobject.MaterialCode + `BusinessLaunchDate'/>
                        <span class="fas fa-calendar-alt input_height data-datepicker"></span>
                        </div>`;
                    }
                    else if (businessLaunchDateValue != rowobject.BusinessLaunchDate) {

                        return `<div class="text-left datepicker-container calender-icon">
                        <input type="text" onpaste="return false;" autocomplete = "off" value="`+ businessLaunchDateValue + `" class="form-control input_height data-datepicker BusinessLaunchDate datepicker-input" id='` + rowobject.MaterialCode + `BusinessLaunchDate'/>
                        <span class="fas fa-calendar-alt input_height data-datepicker"></span>
                        </div>`;
            ...
            formatter: function (cellvalue, options, rowobject) {
                ...
                if (rowobject.StatusId != 3) {
                    if (rAndDLaunchDateValue == "" || rAndDLaunchDateValue == null || rAndDLaunchDateValue == undefined) {
                        ...
                        return `<div class="text-left datepicker-container calender-icon">
                    <input type="text" onpaste="return false;" autocomplete = "off" class="form-control input_height data-datepicker RandDLaunchDate datepicker-input" id='`+ rowobject.MaterialCode + `RandDLaunchDate'/>
                    <span class="fas fa-calendar-alt input_height data-datepicker"></span>
                    </div>`;
                    }
                        ...
                        return `<div class="text-left datepicker-container calender-icon">
                    <input type="text" value="`+ rAndDLaunchDateValue + `" onpaste="return false;" autocomplete = "off" class="form-control input_height data-datepicker RandDLaunchDate datepicker-input" id='` + rowobject.MaterialCode + `RandDLaunchDate'/>
                    <span class="fas fa-calendar-alt input_height data-datepicker"></span>
                    </div>`;
                    }
                    else {
                    ...
                    <span class="fas fa-calendar-alt input_height data-datepicker"></span>
                        ...
                        return `<div class="text-left datepicker-container calender-icon">
                            ...
                            <span class="fas fa-calendar-alt input_height data-datepicker save_edit"></span>
            ...
            formatter: function (cellvalue, options, rowobject) {
                ...
                if (rowobject.StatusId != 3) {
                    ...
                    if (isNpdValue == "" || isNpdValue == null || isNpdValue == undefined) {
                        ...
                        return `<div class="d-flex action_icons align-items-center single-select_dropdown IsNpdOption">
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            findDivisionCount(launchInfoInitialData);
...
function NPDListLoad(flag, DivisionName) {
    ...
    if (npdLaunchYearType == "") {
        npdLaunchYearType = 'All';
    }
