...
function getL2ApprovalInfo() {
    ...
    $.ajax({
        type: "POST",
        url: ROOT + "NewProjectInitiation/GetL2ApprovalProjectInfo",
        dataType: "json",
...
function BackButton() {
    var projectId = $("#ProjectId").val();
    window.location.href = ROOT + "NewProjectInitiation/BaseLineBudgetApprovalPhase1" + '?q=' + Encrypt("ProjectId=" + projectId);
}
