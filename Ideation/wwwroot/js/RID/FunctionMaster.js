    ...
    [
        {
            ...
            formatter: function (cellvalue, options, rowobject) {
                return '<div class="justify-center_">' +
                    '<a href="#" class="btn-icon -edit" onclick="EditFunction(this)" data-functionid="' + rowobject.FunctionId + '" data-functionname = "' + rowobject.FunctionName + '" data-status=' + rowobject.Status + ' title="Edit">' +
