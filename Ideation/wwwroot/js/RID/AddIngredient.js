    ...
    [
        ...
        },
        {
            ...
            formatter: function (cellvalue, options, rowobject) {
                if (rowobject.IsEditable == true) {
                    return '<div class="demo-content">' +
                        '<textarea class="form-control textvalid form-control-sm Cremarks_text" id="cremarks_selected_' + rowobject.RowNo + '" rows="4" cols="40" data-lineno="' + rowobject.RowNo + '" data-name="' + options.colModel.name + '"></textarea>' +
                        '<span class="text-danger _hide" id="cremarks_selected_' + rowobject.RowNo + '_valid" >Please enter Remarks</span>' +
                        '</div>';
                }
                else {
                    return '<div class="demo-content">' +
                        '<textarea class="form-control textvalid form-control-sm Cremarks_text" id="cremarks_selected_' + rowobject.RowNo + '" rows="4" cols="40" data-lineno="' + rowobject.RowNo + '" data-name="' + options.colModel.name + '"readonly></textarea>' +
                        '<span class="text-danger _hide" id="cremarks_selected_' + rowobject.RowNo + '_valid" >Please enter Remarks</span>' +
                        '</div>';
                }
    ...
    },
    {
        ...
        formatter: function (cellvalue, options, rowobject) {
            if (rowobject.IsEditable == true) {
                ...
                return '<div class="demo-content">' +
                    '<textarea class="form-control textvalid form-control-sm Cremarks_text" id="cremarks_selected_' + rowobject.RowNo + '" rows="4" cols="40" data-lineno="' + rowobject.RowNo + '" data-name="' + options.colModel.name + '">' + rowobject.CRemarks + '</textarea>' +
                    '<span class="text-danger _hide" id="cremarks_selected_' + rowobject.RowNo + '_valid" >Please enter Remarks</span>' +
                    '</div>';
            }
            else {
                return '<div class="demo-content">' +
                    '<textarea class="form-control textvalid form-control-sm Cremarks_text " id="cremarks_selected_' + rowobject.RowNo + '" rows="4" cols="40" data-lineno="' + rowobject.RowNo + '" data-name="' + options.colModel.name + '" readonly>' + rowobject.CRemarks + '</textarea>' +
                    '<span class="text-danger _hide" id="cremarks_selected_' + rowobject.RowNo + '_valid" >Please enter Remarks</span>' +
                    '</div>';
            }
        }
    ...
    },
    {
        ...
        formatter: function (cellvalue, options, rowobject) {
            ...
            if (index > -1) {
                ...
                return '<div class="d-flex action_icons align-items-center ">' +
                    '<a href="#" title="Download" class="btn-icon btn-success" onclick="downloadoc(this)" data-region="' + rowobject.RegionId + '" data-category="' + rowobject.CategoryId + '" data-enclosure="' + rowobject.EnclosureName + '" ><i class="fas fa-download color-download"></i></a>' +
                    '</div >';
            }
...
$('#cancelbtn').click(function () {
    var divisionid = $("#Division_Id").val();
    window.location.href = ROOT + "NewRID/IngredientsRegulation?DivisionId";
});
