    ...
    },
    {
        ...
        formatter: function (cellvalue, options, rowobject) {
            return '<div class="Project_Id_col" title="' + cellvalue + '">' +
                '<a class="text-info color-blue" title="' + cellvalue + '" style="white-space: wrap;" href="' + ROOT + 'ProjectMaster/ProjectBudgetTransfer?q=' + Encrypt('ProjectId=' + rowobject.ProjectId) + '">' + cellvalue + '</a>' + '</div>';
        }
    },
    {
        name: 'ProjectName',
...
colmodels = [
    ...
    },
    {
        ...
        exportcol: false,
        formatter: function (cellvalue, options, rowobject) {
            return '<a class="value_info"> <span class="color-brown">' + cellvalue + '</span></a>'
