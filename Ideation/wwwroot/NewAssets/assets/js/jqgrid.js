...
function CreateJQGrid(selector, url, mtype, params, colmodels, token, enableAuthorization = false, enableMultiselect = false) {
    ...
    $(selector).jqGrid({
        ...
        viewrecords: true,
        rowNum: enableMultiselect ? params.length : 20,
        scroll: 1,
